    ...
    <div>
      ...
      <section className="bg-gradient-to-r from-orange-400 to-brown-400 text-white py-12">
        <div className="container mx-auto text-center">
          ...
          <a href="#" className="btn-primary text-white text-lg font-semibold px-6 py-3 rounded-full transition duration-300 ease-in-out hover:bg-orange-600">Explore Now</a>
        </div>
      </section>
