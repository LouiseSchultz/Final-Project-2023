    ...
    <div>
      ...
      <section className='bg-secondary text-black py-12'>
        <div className='container mx-auto text-center'>
          <h1 className='text-4xl font-extrabold mb-4'>Die Bücherecke </h1>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8'>
            ...
            <div className='bg-white shadow-lg rounded-lg overflow-hidden flex flex-col'>
              ...
              <div className='p-4 flex-grow'>
                ...
                <div className='mt-4 flex-grow'>
                  <Link
                    to={`/books/65254b948b1dfa56d801c612`}
            ...
            <div className='bg-white shadow-lg rounded-lg overflow-hidden flex flex-col'>
              ...
              <div className='p-4 flex-grow'>
                ...
                <div className='mt-4 flex-grow'>
                  <Link
                    to={`/books/65254b948b1dfa56d801c608`}
                    className='btn btn-primary'>
                    Zum Buch
                  </Link>
                </div>
            ...
            <div className='bg-white shadow-lg rounded-lg overflow-hidden flex flex-col'>
              ...
              <div className='p-4 flex-grow'>
                ...
                <div className='mt-4 flex-grow'>
                  <Link
                    to={`/books/65254b948b1dfa56d801c60e`}
                    className='btn btn-primary'>
                    Zum Buch
                  </Link>
                </div>
            ...
            <div className='bg-white shadow-lg rounded-lg overflow-hidden flex flex-col'>
              ...
              <div className='p-4 flex-grow'>
                ...
                <div className='mt-4 flex-grow'>
                  <Link
                    to={`/books/65254b948b1dfa56d801c610`}
                    className='btn btn-primary'>
                    Zum Buch
                  </Link>
                </div>
