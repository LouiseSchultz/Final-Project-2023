...
export const registerUser = createAsyncThunk('auth/registerUser', async ({ vorName, nachNname,strasse,hausNummer,
  postleitzahl,ort,telefon, email, password, username }, { rejectWithValue }) => {
  try {
    const config = {
      headers: {
    ...
    await axios.post('/register', { vorName, nachNname, strasse,hausNummer,postleitzahl,ort,
      telefon, email, password, username }, config)
...
export const loginUser = createAsyncThunk("auth/loginUser", async ({ email, password }, { rejectWithValue }) => {
  try {
    ...
    let res = await axios.post("/login", { email, password }, config)
    let data = res.data
